"""s module can be used as both a script and an importable module.
    ...
    def __init__(self, pblm, pccs, dim=224, augment=True, transform=None):
       ...
       # print('len aids',len(all_aids))
        all_fpaths = pblm.infr.ibs.depc_annot.get(
            ...
            config=chip_config)
        import utool as ut
       # print(ut.repr3(pblm.infr.connected_component_status()))
       # print(ut.repr3(pblm.infr.status()))
